...
# ---------------------------------------------------------------------------
# Frozen source-gauge consistency
# ---------------------------------------------------------------------------


def test_coupling_factor_shares_imported_device_gauge():
    """The transmon factor and imported charge operator share one source gauge."""
    hs = _transmon_oscillator_hilbertspace()
...
def test_driven_proxy_spectrum_gauge_consistent():
    """A charge term added to the frozen import reproduces the source spectrum."""
...
def test_fluxonium_composite_snapshot_reproduces_spectrum():
    """A frozen composite import preserves the source truncation and gauge."""
